import{$ as o}from"./jquery-995cfbaf.js";import{S as n}from"./sprite-3002caef.js";import{i as d}from"./dropDownMenu-8d97c7ef.js";import{n as h,o as m,r as u}from"./queries.graphql.d-f9acd4bb.js";const g="data:image/webp;base64,",p="data:image/webp;base64,";class w{container;games;constructor(e){this.container=o(e),this.games=[{name:"CS:GO",image:g,dataGame:"cs2"},{name:"DOTA 2",image:p,dataGame:"dota2"}],this.init()}init(){this.renderDropdown(),this.addEventListeners(),this.setInitialGameSelection()}renderDropdown(){const e=`
      <div class="dropdown__game-select">
        ...
        <div class="dropdown__game-arrow">
          <svg>
            <use xlink:href="${n}#arrow-game"></use>
          </svg>
        </div>
  ...
  <label for="headerSearch" class="header__search-block">
    ...
    />
      ...
      <div class="header__user-block">
        ...
        `)}}function A(r){const t=`; ${document.cookie}`.split(`; ${r}=`);return t.length===2?t.pop().split(";").shift():null}async function l(r,e={},t,a="https://battle-star-app.onrender.com/graphql"){try{const s=await u(a,r,e,{Authorization:`Bearer ${t}`});if(s)return console.log("Response:",s),s;throw new Error("No response data received")}catch(s){throw console.error("Error in getRequest:",s),s}}class P{containerId;items;activeItemTitle;constructor(e,t){this.containerId=e,this.activeItemTitle=t,this.items=[{title:"ГЛАВНАЯ",icon:`${n}#newspaper`,link:"/index.html"},{title:"МАТЧИ",icon:`${n}#controller`,link:"/match.html"},{title:"ТУРНИРЫ",icon:`${n}#cup`,link:"/tournaments.html"},{title:"КОМАНДЫ",icon:`${n}#people`,link:"/teams.html"},{title:"ДРУЗЬЯ",icon:`${n}#person`,link:"/friends.html"}],this.render()}render(){const e=document.getElementById(this.containerId);if(!e)throw new Error(`Container with id #${this.containerId} not found.`);const t=document.createElement("div");t.className="sidebar";const a=this.createLogoAnchor(),s=this.createNav();t.appendChild(a),t.appendChild(s),e.appendChild(t)}createLogoAnchor(){const e=document.createElement("a");e.className="sidebar__logo",e.href="/index";const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("class","sidebar__logo");const a=document.createElementNS("http://www.w3.org/2000/svg","use");return a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",`${n}#logo`),t.appendChild(a),e.appendChild(t),e}createNav(){const e=document.createElement("nav");return e.className="sidebar__nav",this.items.forEach(t=>{const a=this.createNavItem(t);e.appendChild(a)}),e}createNavItem(e){const t=document.createElement("a");t.href=e.link,t.className=`sidebar__nav-item ${e.title===this.activeItemTitle?"sidebar__nav-item_active":""}`;const a=document.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("class","sidebar__nav-item-icon");const s=document.createElementNS("http://www.w3.org/2000/svg","use");s.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",e.icon),a.appendChild(s);const i=document.createElement("span");return i.className="sidebar__nav-item-text",i.textContent=e.title,t.appendChild(a),t.appendChild(i),t}}export{P as A,k as H};
