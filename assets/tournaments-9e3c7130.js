import"./modulepreload-polyfill-3cfb730f.js";import{$ as p}from"./jquery-ab814638.js";import{S as l}from"./swiper-core-75041738.js";import{N as m}from"./navigation-34d3ce35.js";import"./gameselect-ca50b108.js";import{S as s}from"./sprite-46903b3d.js";import{g as o,s as u}from"./windowLocation-8fc17d29.js";import{B as _,L as b}from"./lava-lamp-23e0d20d.js";import{r as v,e as h,f}from"./queries.graphql.d-b80ad75d.js";import{T as $}from"./tabs-create-7a28c516.js";import"./dropDownMenu-e31617c8.js";class w{containerId;tournaments;constructor(a,t){this.containerId=a,this.tournaments=t,this.render()}render(){const a=o("game")??"cs2",t=this.tournaments.map(n=>`
  ...
  </button>`,a+="</div>"),a}}class x{containerId;tournaments;swiper=null;constructor(a,t){this.containerId=a,this.tournaments=t,this.render(),this.initializeSwiper()}render(){const a=this.tournaments.map(e=>`<div class="tournaments-swiper__swiper-slide swiper-slide tournaments-slide">
