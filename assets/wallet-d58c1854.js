import{$ as t}from"./jquery-e7e79cb6.js";import{S as a,s as _,P as b}from"./header-6881e6b7.js";import{s as c}from"./history-391f8a09.js";import{A as u}from"./asideMenu-3b28381d.js";import"./sidebar-01266bb8.js";new u;class v{content;wallet;subscriptionSelectBtn;transactionBtn;btns;result;constructor(s,e){this.content=s,this.wallet=e,this.subscriptionSelectBtn=t(".subscription__select-btn"),this.transactionBtn=t(".transaction__select-user"),this.btns=t(".btn_money"),this.result=t(".wallet__row-balance-sum"),this.renderWallet(),this.init()}init(){this.selectSubscription(),this.loadSavedSubscription(),this.dropdown(),this.findUser(),this.transaction()}renderWallet(){const s=`
