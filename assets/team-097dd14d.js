import{$ as m}from"./jquery-62de4648.js";import{H as c,g as r,F as l,I as n,r as g}from"./header-fb3b444a.js";import{A as p}from"./sidebar-6eae4002.js";class o{id;attributes;constructor(a){this.id=a.id||"",this.attributes=a.attributes||{}}getTemplate(){const a=this.attributes.Team||{};let t="";return(this.attributes.awards?.data||[]).forEach(e=>{t+=`<img class="team-item__award-img" src="${e.attributes.logo.data[0].attributes.url}" alt="award">`}),`<a href="/team.html?id=${this.id}" class="teams-list__team-item team-item">
