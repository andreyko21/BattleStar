import{$ as t}from"./jquery-e7e79cb6.js";import{S as a,s as _,K as b}from"./header-5f3752b8.js";import{s as c}from"./history-3a4d9e28.js";import{A as u}from"./asideMenu-3b28381d.js";import"./sidebar-d6fc8472.js";new u;class v{content;wallet;subscriptionSelectBtn;transactionBtn;btns;result;constructor(s,e){this.content=s,this.wallet=e,this.subscriptionSelectBtn=t(".subscription__select-btn"),this.transactionBtn=t(".transaction__select-user"),this.btns=t(".btn_money"),this.result=t(".wallet__row-balance-sum"),this.renderWallet(),this.init()}init(){this.selectSubscription(),this.loadSavedSubscription(),this.dropdown(),this.findUser(),this.transaction()}renderWallet(){const s=`
