        ...
        <svg>
         ...
         <svg>
           ...
           <svg>
             ...
             </tr>`).join(""),a=document.querySelector(this.content);a&&(a.innerHTML=s)}}const m=await d("https://battle-star-app.onrender.com/graphql",p),_=m.usersPermissionsUsers?.data.at(-1);let i={id:_?.id,nickname:_?.attributes?.username,balance:n};console.log(i);new u(".wallet__top",i);new v(".table__tab",i);
