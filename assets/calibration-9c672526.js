import"./jquery-e7e79cb6.js";import{g as l,S as p,r as b,i as h,H as m}from"./header-16820d9b.js";import{B as u,S as c,O as i,M as g,a as _}from"./sorting-block-e6ed9be3.js";import{B as n}from"./tabs-2b5eea74.js";import{A as v}from"./sidebar-9bd795e4.js";class f extends u{constructor(e,t,a){super(e,t,a),this.addBtnListnerForNotNow(),this.addBtnListnerForNow()}addBtnListnerForNotNow(){this.popUp.querySelector("#not-now")?.addEventListener("click",()=>{const t=l("game");t==null||t==null?location.replace("match.html?game=cs2"):location.replace(`match.html?game=${t}`)})}addBtnListnerForNow(){this.popUp.querySelector("#start-calibration")?.addEventListener("click",()=>this.close())}}class w{container;options;popUp;constructor(e,t,a){this.container=document.querySelector(`#${e}`),this.options=t,this.popUp=a,this.render(),this.addEventHendler()}render(){const e=this.options.reduce((t,a)=>(t+=`
