import{$ as l}from"./jquery-62de4648.js";import{r as o,R as n,S as p,H as f,T as h}from"./header-4ffbce13.js";import{B as u}from"./tabs-18cd2ba9.js";import{L as g}from"./lava-lamp-05022cec.js";import{p as x}from"./playersCs-68918191.js";import{A as $}from"./sidebar-1114d44a.js";class b{content;data;searchParams;lobbyId;constructor(s,t){this.content=s,this.data=t,this.searchParams=new URLSearchParams(window.location.search),this.lobbyId=this.searchParams.get("id"),this.renderStatistic()}async renderStatistic(){const e=((await o("https://battle-star-app.onrender.com/graphql",n,{id:this.lobbyId}))?.csLobby?.data??{})?.attributes?.gameMode?.data?.attributes?.value;if(e){const r=`
