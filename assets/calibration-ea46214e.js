import"./modulepreload-polyfill-3cfb730f.js";import{B as h,f as e}from"./pop-up-052d1b01.js";import{B as n,L as o}from"./lava-lamp-a2551edf.js";import"./jquery-ab814638.js";class p{container;options;constructor(c,t){this.container=document.querySelector(`#${c}`),this.options=t,this.render()}render(){const c=this.options.reduce((t,a)=>(t+=`<tr class="match-tr content__tr" id="${a.id}">
       ...
       </tr>`,t),"");this.container.innerHTML=c}}class g{container;options;constructor(c,t){this.container=document.querySelector(`#${c}`),this.options=t,this.render()}render(){const c=this.options.reduce((t,a)=>(t+=`<div class="match-card" id="${a.id}">
...
</div>`,t),"");this.container.innerHTML=c}}const d="/assets/map-img-5a71a888.png";class ${container;tabsClass;tabsParam;constructor(c,t,a){if(this.tabsClass=t,this.tabsParam=a,this.container=document.querySelector(`#${c}`),!this.container)throw new Error(`Container with id #${c} not found.`);this.render()}render(){const c=this.tabsParam.reduce((s,r)=>(s+=`
      <div
