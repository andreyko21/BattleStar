import"./modulepreload-polyfill-3cfb730f.js";import{$ as n}from"./jquery-995cfbaf.js";import{B as r,L as u}from"./lava-lamp-91bf70b1.js";import{A as o,H as l}from"./sidebar-f3222882.js";import{S as e}from"./sprite-3002caef.js";import{T as _}from"./tabs-create-b6236109.js";import"./windowLocation-a7eb2864.js";import"./dropDownMenu-8d97c7ef.js";import"./queries.graphql.d-f9acd4bb.js";class m{container;users;constructor(s,t){this.container=n(s),this.users=t,this.render()}render(){this.container.append(this.createChatSectionHtml()),this.renderUsers()}createChatSectionHtml(){return`
  ...
  />
      ...
      </section>`}renderUsers(){const s=this.users.map(t=>this.createUserHtml(t)).join("");this.container.find("#list-users").html(s),this.attachMenuEventHandlers()}attachMenuEventHandlers(){this.container.find(".user").each((s,t)=>{const a=n(t);a.find(".user__setting-button").on("click",function(){a.find(".user-menu").toggle()}),a.on("mouseleave",function(){a.find(".user-menu").hide()})})}createUserHtml(s){return`
    <div class="user">
    ...
    </div>`}}class h{container;users;constructor(s,t){this.container=n(s),this.users=t,this.render()}render(){this.container.append(this.createChatSectionHtml()),this.renderUsers()}createChatSectionHtml(){return`
      <section class="page__chat-section chat-section">
        <div class="chat-section__sidebar chat-section-sidebar">
          <div class="chat-section-sidebar__search-block">
            <label class="input__search">
  ...
  />
    ...
    <div class="user user_request">
      ...
      <div class="user__rank">
        <img class="user__rank-img" src="${c}" alt="Rank" />
      </div>
    ...
    </div>`}}class d{container;users;constructor(s,t){this.container=n(s),this.users=t,this.render()}render(){this.container.append(this.createChatSectionHtml()),this.renderUsers()}createChatSectionHtml(){return`<section class="page__search-section search-section">
    ...
    </div>`}}class v{constructor(){new l(".wrapper"),new _("tabs-block","users-page__filters",[["onlineUsers","ОНЛАЙН"],["allUsers","ВСЕ"],["request","ЗАЯВКИ"],["search","ПОИСК"]]),new r("users-page__filters"),new u("users-page__filters"),n("#onlineUsers-content").addClass("tabs-block__content-container_active"),new m("#onlineUsers-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0}]),new h("#allUsers-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0}]),new g("#request-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0}]),new d("#search-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:"/src/images/user-sidebar.svg",online:!0}])}}new v;new o("wrapper","ДРУЗЬЯ");
