import"./modulepreload-polyfill-3cfb730f.js";import{$ as c}from"./jquery-995cfbaf.js";import{C as d}from"./auto-f06b4c5b.js";import{S as e}from"./sprite-3002caef.js";import{T as p}from"./tabs-create-b6236109.js";import{B as v,L as g}from"./lava-lamp-91bf70b1.js";import{H as h,A as b}from"./sidebar-073b13a8.js";import"./windowLocation-a7eb2864.js";import"./dropDownMenu-8d97c7ef.js";import"./queries.graphql.d-f9acd4bb.js";const i="/assets/avatar-b55cc117.png",n="/assets/team-avatar-25d369d5.png",o="/assets/award-d2bab478.svg";class m{content;statistics;constructor(t,s){this.content=t,this.statistics=s,this.renderStatisticsCsRating()}renderStatisticsCsRating(){const t=`
   ...
   `,s=document.querySelector(this.content);s&&(s.innerHTML=t)}}const u=[{rang:1682,rangImg:"../../../src/images/rank.png",tour:2,winrate:60,time:200}];class f{content;statistics;constructor(t,s){this.content=t,this.statistics=s,this.renderStatisticsCs()}renderStatisticsCs(){const t=`
    ...
    <div class="statistics__cs-schedule">
     ...
     <div class="statistics__cs-schedule">
      ...
      </a>`}}c(document).ready(()=>{const r={avatar:i,name:"John Doe",isOnline:!0,firstGameDate:"January 1, 2020",biography:"Gamer biography here"},t={online:[{onlineStatus:"online",avatar:i,name:"Friend One",status:"Playing Game A"},{onlineStatus:"offline",avatar:i,name:"Friend Two",status:"Last seen 2 hours ago"}],all:[{onlineStatus:"online",avatar:i,name:"Friend One",status:"Playing Game A"},{onlineStatus:"offline",avatar:i,name:"Friend Two",status:"Last seen 2 hours ago"},{onlineStatus:"online",avatar:i,name:"Friend One",status:"Playing Game A"},{onlineStatus:"offline",avatar:i,name:"Friend Two",status:"Last seen 2 hours ago"}]},s=[{link:"#",avatar:n,name:"Team One",rating:2e3,tournaments:5,earned:"5000 BS",members:10,award:o},{link:"#",avatar:n,name:"Team One",rating:2e3,tournaments:5,earned:"5000 BS",members:10,award:o},{link:"#",avatar:n,name:"Team One",rating:2e3,tournaments:5,earned:"5000 BS",members:10,award:o},{link:"#",avatar:n,name:"Team One",rating:2e3,tournaments:5,earned:"5000 BS",members:10,award:o},{link:"#",avatar:n,name:"Team One",rating:2e3,tournaments:5,earned:"5000 BS",members:10,award:o},{link:"#",avatar:n,name:"Team One",rating:2e3,tournaments:5,earned:"5000 BS",members:10,award:o}];new h("#wrapper"),new b("wrapper","ДРУЗЬЯ"),new $(".page__container",r,t,s),new p("main-statistics","user-page__filters",[["cs2","CS2"],["dota2","Dota2"]]),c("#cs2-content").addClass("tabs-block__content-container_active"),new v("user-page__filters"),new g("user-page__filters"),c("#dota2-content").append(`<div class="dota2-info-block statistics__top"></div>
