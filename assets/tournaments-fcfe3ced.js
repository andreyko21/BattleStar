import"./modulepreload-polyfill-3cfb730f.js";import{$ as u}from"./jquery-995cfbaf.js";import{S as d}from"./swiper-core-75041738.js";import{N as m}from"./navigation-34d3ce35.js";/* empty css                      */import{S as r}from"./sprite-b43800c4.js";import{g as o,s as c}from"./windowLocation-8fc17d29.js";import{B as _,L as b}from"./lava-lamp-9b7ca11c.js";import"./gameselect-9d669fe9.js";import{r as v,i as h,j as f}from"./queries.graphql.d-5a708c92.js";import{T as $}from"./tabs-create-7a28c516.js";import"./dropDownMenu-e31617c8.js";const w="/assets/honeycombs-065ef4c7.png";class P{containerId;tournaments;constructor(a,t){this.containerId=a,this.tournaments=t,this.render()}render(){const a=o("game")??"cs2",t=this.tournaments.map(n=>`
        ...
        </button>`,a+="</div>");const e=document.getElementById(this.containerId);e&&(e.innerHTML=a)}}class x{currentPage;pageCount;constructor(a,t){this.currentPage=t,this.pageCount=a.pagination.pageCount}bindEvents(a){a.on("click",".page-pagination__button",t=>{c("page",t.currentTarget.id)}),a.on("click",".page-pagination__button-nav",t=>{t.currentTarget.id=="next"?this.currentPage++:t.currentTarget.id=="prev"&&this.currentPage--,this.currentPage>this.pageCount?this.currentPage=this.pageCount:this.currentPage<1&&(this.currentPage=1),c("page",this.currentPage)})}render(){let a="",t="";for(let e=1;e<=this.pageCount;e++)e==this.currentPage?t+=`<button id="${e}" class="page-pagination__button page-pagination__button_active">${e}</button>`:e==1||e==this.pageCount||e==this.currentPage-1||e==this.currentPage+1?t+=`<button id="${e}" class="page-pagination__button">${e}</button>`:(e==this.currentPage-2||e==this.currentPage+2)&&(t+='<p class="page-pagination__elips">...</p>');return this.pageCount>0&&(a+='<div class="teams-list-section__teams-list-pagination page-pagination">',this.currentPage>1?a+=`<button id="prev" class="page-pagination__button-nav page-pagination__button-prev">
    <svg class="page-pagination__button-prev-icon">
      <use xlink:href="${r}#arrow-left"></use>
    </svg>
    ...
    <svg class="page-pagination__button-next-icon">
      <use xlink:href="${r}#arrow-right"></use>
            ...
            `)}initializeSwiper(){this.swiper=new d(".swiper",{modules:[m],loop:!0,navigation:{nextEl:".tournaments-swiper__button-next",prevEl:".tournaments-swiper__button-prev"}})}}u(document).ready(async()=>{let s,a,t,e;o("game")=="dota2"?s=h:s=f,o("page")?e=o("page"):e=1,a=await v("https://battle-star-app.onrender.com/graphql",s,{currentPage:e,pageSize:9},{Authorization:"Bearer "}),a.dota2Tournaments?t=a.dota2Tournaments:t=a.cs2Tournaments,new T("page-pagination",t.meta,1),new x(t.meta,1),new P("tournaments-cards-block",[...t.data.map(i=>({id:i.id,imageUrl:i.attributes.Tournament.logo.data.attributes.url,date:`${p(i.attributes.Tournament.startDate)} - Начало в ${i.attributes.Tournament.time.split(":").slice(0,2).join(":")}`,name:i.attributes?.Tournament?.name,prize:"200000 $",minRating:"1200+",regionLimit:"Весь мир"}))]);const l=[...t.data.map(i=>({id:i.id,title:i.attributes?.Tournament?.name,description:i.attributes.Tournament.description,imageUrl:i.attributes.Tournament.logo.data.attributes.url,date:`${p(i.attributes.Tournament.startDate)} - ${p(i.attributes.Tournament.endDate)}`,teams:i.attributes.teams.data.map(g=>({name:g.attributes.Team.name,rank:g.attributes.Team.rating,avatar:g.attributes.Team.logo.data.attributes.url}))}))];new k("tournament-container",l)});function p(s){const a=["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],t=new Date(s),e=t.getDate(),n=t.getMonth();return e+" "+a[n]}new $("tournaments-nav__tabs","match-page__filters",[["amateurTournaments","ЛЮБИТЕЛЬСКИЕ ТУРНИРЫ"],["profesionalTournaments","ПРОФЕССИОНАЛЬНЫЕ ТУРНИРЫ"]]);u("#tournamentGrid-content").addClass("tabs-block__content-container_active");new _("match-page__filters");new b("match-page__filters");u(document).ready(()=>{u(".tournaments-nav__create-button").on("click",()=>{const s=o("game");s==null||s==null?window.location.href='/createTournament.html?game="cs2"':window.location.href=`/createTournament.html?game="${s}"`})});
