...
//    if (this.creatorData.userId !== null) {
//      this.params.creator = Number.parseFloat(this.creatorData.userId);
//    }
//  }
...
//    if (this.creatorData.playerId !== null) {
//      if (!this.params.participant?.includes(+this.creatorData.playerId)) {
