import{$ as l}from"./jquery-e7e79cb6.js";import{r as d,D as o,S as m,H as f}from"./header-e5047e00.js";import{B as h}from"./tabs-0f134427.js";import{L as g}from"./lava-lamp-63313dfc.js";import{p}from"./playersCs-339c7e36.js";import{A as u}from"./sidebar-a515cb42.js";class b{content;data;searchParams;lobbyId;constructor(s,a){this.content=s,this.data=a,this.searchParams=new URLSearchParams(window.location.search),this.lobbyId=this.searchParams.get("id"),this.renderStatistic()}async renderStatistic(){const c=((await d("https://battle-star-app.onrender.com/graphql",o,{id:this.lobbyId}))?.csLobby?.data??{})?.attributes?.gameMode?.data?.attributes?.value;if(c){const r=`
