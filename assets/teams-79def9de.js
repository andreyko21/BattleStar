import{$ as o}from"./jquery-e7e79cb6.js";import{H as v,h as c,s as T,k as g,m as y,n as w,o as $,p as b,q as k,t as D,r as S,S as A}from"./header-f70ba31e.js";import{A as C}from"./sidebar-bc1ddcde.js";import{T as z}from"./tabs-create-b6236109.js";import{B as q}from"./tabs-854fe48d.js";import{L as G}from"./lava-lamp-63313dfc.js";class L{userId=null;tabInitialized={openTeams:!1,topTeams:!1,myTeams:!1};constructor(){this.fetchAndSetUserId().then(()=>{const t=c("game"),i=c("teams-filters")||"myTeams";this.initializeTabs(t,i)})}async fetchAndSetUserId(){try{const t=await this.getRequest(g);t&&t.me&&t.me.id&&(this.userId=t.me.id)}catch(t){console.error("Error fetching user info:",t)}}initializeTabs(t,i){["openTeams","topTeams","myTeams"].forEach(e=>{this.initializeTabContent(e),this.tabInitialized[e]=!0,o(`#${e}-tab`).on("click",()=>{this.fetchAndDisplayTeams(e,t)}),this.fetchAndDisplayTeams(e,t)})}async fetchAndDisplayTeams(t,i){const a=o(`#${t}-content .sort__select`).val(),e=o(`#${t}-content .input__search-input`).val(),s=await this.fetchTeamsData(a,e,i,t);this.displayTeams(s,t)}initializeTabContent(t){const a=`
    ...
    </div>`;o(`#${t}-content`).append(a),o(`#${t}-content .sort__select`).on("change",e=>{const s=o(e.target).val(),n=c("game");this.fetchTeamsData(s,"",n,t).then(r=>{this.displayTeams(r,t)})}),o(`#${t}-content .input__search-input`).on("input",this.debounce(e=>{const n=e.target.value,r=o(`#${t}-content .sort__select`).val(),m=c("game");this.fetchTeamsData(r,n,m,t).then(l=>{this.displayTeams(l,t)})},300,!1))}async fetchTeamsData(t,i,a,e){try{let s,n={sorting:[t],filtering:i,page:1,pageSize:10,id:this.userId};e==="topTeams"?s=a==="dota2"?y:w:e==="myTeams"?s=a==="dota2"?$:b:s=a==="dota2"?k:D;const r=await this.getRequest(s,n),m=a==="dota2"?r.dota2Teams?.data:r.cs2Teams?.data;return m?m.map(l=>{const p=l.attributes.Team[0],u=p.logo.data.attributes.url,d=l.attributes.players.data.length,h=l.attributes.tournaments.data.length,_=l.attributes.awards.data,f=_.length>0?_[0].attributes.logo.data.attributes.url:null;return{link:"#",avatar:u,name:p.name,rating:String(p.rating),tournaments:String(h),earned:String(p.earned),members:`${String(d)}/15`,award:f}}):[]}catch(s){throw console.error("Error in fetchTeamsData:",s),s}}displayTeams(t,i){const a=`#${i}-content .teams-section__list`;o(a).empty(),t.forEach(e=>{o(a).append(this.createTeamListItem(e))})}createTeamListItem(t){const i=t.award?`<div class="team-list__team-awards-item"><img src="${t.award}" alt="award" /></div>`:"";return`<a class="team-list__team" href="${t.link}">
