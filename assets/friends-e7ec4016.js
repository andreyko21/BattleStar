import"./modulepreload-polyfill-3cfb730f.js";import{B as l,L as m}from"./lava-lamp-91bf70b1.js";import{A as _,H as h}from"./sidebar-073b13a8.js";import{$ as i}from"./jquery-995cfbaf.js";import{S as e}from"./sprite-3002caef.js";import{T as d}from"./tabs-create-b6236109.js";import{g as r,s as b}from"./windowLocation-a7eb2864.js";import"./dropDownMenu-8d97c7ef.js";import"./queries.graphql.d-f9acd4bb.js";const c="data:image/png;base64,";class g{container;users;constructor(s,t){this.container=i(s),this.users=t,this.render()}render(){this.container.append(this.createChatSectionHtml()),this.renderUsers()}createChatSectionHtml(){return`
  ...
  />
    ...
    </div>`}}class v{container;users;constructor(s,t){this.container=i(s),this.users=t,this.render()}render(){this.container.append(this.createChatSectionHtml()),this.renderUsers()}createChatSectionHtml(){return`
      <section class="page__chat-section chat-section">
        <div class="chat-section__sidebar chat-section-sidebar">
          <div class="chat-section-sidebar__search-block">
            <label class="input__search">
  ...
  />
    ...
    <div class="user user_request">
      ...
      <div class="user__rank">
        <img class="user__rank-img" src="${o}" alt="Rank" />
      </div>
    ...
    </div>`}}class k{container;users;constructor(s,t){this.container=i(s),this.users=t,this.render()}render(){this.container.append(this.createChatSectionHtml()),this.renderUsers()}createChatSectionHtml(){return`<section class="page__search-section search-section">
    ...
    </div>`}}const n="/assets/user-sidebar-9c14671c.svg";class f{constructor(){new h(".wrapper"),new g("#onlineUsers-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0}]),new v("#allUsers-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0}]),new p("#request-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0}]),new k("#search-content",[{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0},{name:"SergioRicht",status:"Играет в CS:GO",avatar:n,online:!0}])}}r("users-page__filters")==null&&r("users-page__filters")==null&&b("users-page__filters","onlineUsers");new d("tabs-block","users-page__filters",[["onlineUsers","ОНЛАЙН"],["allUsers","ВСЕ"],["request","ЗАЯВКИ"],["search","ПОИСК"]]);new l("users-page__filters");new m("users-page__filters");new f;new _("wrapper","ДРУЗЬЯ");
