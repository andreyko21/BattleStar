import"./modulepreload-polyfill-3cfb730f.js";import{S as t}from"./sprite-3002caef.js";import{$ as s}from"./jquery-ab814638.js";class l{content;personal;constructor(n,a){this.content=n,this.personal=a,this.renderPersonal(),this.changeBio()}changeBio(){s(".personal__row-edit_bio").on("click",()=>{const n=s(".personal__info-biography span"),a=s(".personal__info-nickname span");a.attr("contenteditable","true"),a.addClass("_act"),n.attr("contenteditable","true"),n.addClass("_act"),console.log("click"),n.on("blur",function(){s(this).removeAttr("contenteditable"),s(this).removeClass("_act");const o=s(this).text();e[0].bio=o,console.log(e[0].bio)}),a.on("blur",function(){s(this).removeAttr("contenteditable"),s(this).removeClass("_act");const o=s(this).text();e[0].nickname=o,console.log(e[0].bio)})})}renderPersonal(){const n=`
