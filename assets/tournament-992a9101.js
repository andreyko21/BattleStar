import{$ as m}from"./jquery-e7e79cb6.js";import{S as p,H as S,g,r as E,I as b,J as L}from"./header-edebcf36.js";import{T as y}from"./tabs-create-b6236109.js";import{B as V}from"./tabs-47584354.js";import{L as J}from"./lava-lamp-63313dfc.js";import{S as C}from"./swiper-core-75041738.js";/* empty css                      */import{A as T}from"./sidebar-ab114443.js";class j{container;title;constructor(a,e){this.container=m(a),this.title=e,this.render(),this.setupShareButton()}render(){const a=`
        ...
        `;this.container.append(e)}}class U{container;bannerImage;tournamentDescription;conditionsOfConduct;widgets;constructor(a,e,s,n,i){this.container=m(a),this.bannerImage=e,this.tournamentDescription=s,this.conditionsOfConduct=n,this.widgets=i,this.render()}renderWidgets(){return this.widgets.map(a=>`
        ...
        `;this.container.append(e)}}const G="/assets/main-games-992f867d.png";class M{container;games;constructor(a,e){this.container=m(a),this.games=e,this.render(),this.initializeSwiper()}renderGames(){return this.games.map(a=>`
...
</div>`)}}class W{participants;container;constructor(a,e){this.container=document.getElementById(a),this.participants=e,this.render()}render(){this.container.innerHTML="";const a=document.createElement("div");a.className="tournament-page__participants",this.participants.forEach(e=>{const s=document.createElement("div");s.className="tournament-page-participants__item";const n=document.createElement("div");n.className="tournament-page-participants__item-number";const i=document.createElement("div");i.className="tournament-page-participants__item-avatar";const r=document.createElement("img");r.src=e.avatarUrl,r.alt=e.name,i.appendChild(r);const c=document.createElement("div");c.className="tournament-page-participants__item-name",c.textContent=e.name;const d=document.createElement("div");d.className="tournament-page-participants__item-rank",d.textContent=e.rank.toString(),s.append(n,i,c,d),a.appendChild(s)}),this.container.append(a)}}class B{container;constructor(a){this.container=m(a),this.render()}render(){this.container.append(`<div class="tournament-page__games">
