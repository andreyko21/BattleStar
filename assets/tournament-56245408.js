import"./modulepreload-polyfill-3cfb730f.js";import{$ as m}from"./jquery-ab814638.js";import{S as w}from"./sprite-46903b3d.js";import{T as D}from"./tabs-create-7a28c516.js";import{B as S,L as E}from"./lava-lamp-23e0d20d.js";import{S as L}from"./swiper-core-75041738.js";import"./gameselect-ca50b108.js";import{r as y,c as g,d as V}from"./queries.graphql.d-b80ad75d.js";import{g as v}from"./windowLocation-8fc17d29.js";import"./dropDownMenu-e31617c8.js";class C{container;title;constructor(a,e){this.container=m(a),this.title=e,this.render(),this.setupShareButton()}render(){const a=`
...
<div class="table">
   ...
   <div class="table__content table__content_final">
      ...
      <div class="table__column table__column_one-two">
        ...
        </div>`)}}m(document).ready(async function(){let t,a,e;v("game")=="dota2"?e=V:e=g;const s="https://battle-star-app.onrender.com/graphql";let n=v("id");v("id")||(window.location.href="/tournaments.html");try{t=await y(s,e,{id:n},{Authorization:"Bearer "}),e==g?(a=t.cs2Tournament,a.data==null&&(window.location.href="/tournaments.html?game=cs2")):(a=t.dota2Tournament,a.data==null&&(window.location.href="/tournaments.html?game=dota2"))}catch(d){console.error("GraphQL request failed:",d)}const i="#tournament-page__container",_=a.data?.attributes?.Tournament?.name,r=a.data?.attributes?.Tournament?.logo?.data?.attributes?.url,c=[{status:"Онлайн",teams:[{name:"ApacheLeader",icon:l},{name:"StrongDefender",icon:l}],part:"1/16 финала"},{status:"Онлайн",teams:[{name:"ApacheLeader",icon:l},{name:"StrongDefender",icon:l}],part:"1/16 фіналу"},{status:"Онлайн",teams:[{name:"ApacheLeader",icon:l},{name:"StrongDefender",icon:l}],part:"1/16 фіналу"},{status:"Онлайн",teams:[{name:"ApacheLeader",icon:l},{name:"StrongDefender",icon:l}],part:"1/16 фіналу"}],b="PGL Major Stockholm 2021 — семнадцатый турнир серии Major по Counter-Strike: Global Offensive. Турнир запланированна 23 октября — 7 ноября 2021 года, место соревнований — Авичи-Арена, Стокгольм, Швеция. Призовой фонд турнира — 2 000 000 $. 24 команды будут квалифицированы через серию из специальных RMR-турниров. Это второй турнир серии Major организованный румынской организацией PGL, после PGL Major: Kraków 2017. Этот турнир — первый Major после перерыва, связанного из-за пандемии коронавируса COVID-19.",p="Vесто соревнований — Авичи-Арена, Стокгольм, Швеция. Призовой фонд турнира — 2 000 000 $. 24 команды будут квалифицированы через серию из специальных RMR-турниров. Это второй турнир серии Major организованный румынской организацией PGL, после PGL Major: Kraków 2017. Этот турнир — первый Major после перерыва, связанного из-за пандемии коронавируса COVID-19.",u=[{icon:"cup",title:"2 000 000 $",description:"Призовой фонд"},{icon:"calendar",title:`${o(a.data?.attributes?.Tournament?.startDate)} - ${o(a.data?.attributes?.Tournament?.endDate)}`,description:"Даты проведения"},{icon:"registration",title:"До 15 Окт",description:"Регистрация"},{icon:"people",title:`${a.data?.attributes?.teams?.data.length}/16`,description:"Команд в игре"}],h=[{name:"Stealth Dragons",avatarUrl:"./src/images/teamAvatar.png",rank:1774},{name:"Mighty Eagles",avatarUrl:"./src/images/teamAvatar.png",rank:1623},{name:"Stealth Dragons",avatarUrl:"./src/images/teamAvatar.png",rank:1774},{name:"Mighty Eagles",avatarUrl:"./src/images/teamAvatar.png",rank:1623},{name:"Stealth Dragons",avatarUrl:"./src/images/teamAvatar.png",rank:1774},{name:"Mighty Eagles",avatarUrl:"./src/images/teamAvatar.png",rank:1623},{name:"Stealth Dragons",avatarUrl:"./src/images/teamAvatar.png",rank:1774},{name:"Mighty Eagles",avatarUrl:"./src/images/teamAvatar.png",rank:1623}],A=`${o(a.data?.attributes?.Tournament?.startDate)} - ${o(a.data?.attributes?.Tournament?.endDate)}`,k="2 000 000 $",f=a.data?.attributes?.teams.data.map(d=>({name:d.attributes.Team.name,rank:d.attributes.Team.rating.toString(),avatar:d.attributes.Team.logo?.data?.attributes?.url}));new C(i,_),new T(i,r,b,p,u),new J("#tournament-page__container",A,k,f),new j("#tournament-page__container",c),new D("tournament-page__container","match-page__filters",[["tournamentGrid","ТУРНИРНАЯ СЕТКА"],["gamesSchedule","РАСПИСАНИЕ ИГР"],["participants","УЧАСНИКИ"]]),m("#tournamentGrid-content").addClass("tabs-block__content-container_active"),new S("match-page__filters"),new E("match-page__filters"),new U("#tournamentGrid-content"),new I("participants-content",h),new G("#gamesSchedule-content")});function o(t){const a=["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],e=new Date(t),s=e.getDate(),n=e.getMonth();return s+" "+a[n]}
