import"./modulepreload-polyfill-3cfb730f.js";import{$ as m}from"./jquery-995cfbaf.js";import{S as p}from"./sprite-b43800c4.js";import{T as S}from"./tabs-create-7a28c516.js";import{B as E,L}from"./lava-lamp-9b7ca11c.js";import{S as y}from"./swiper-core-75041738.js";/* empty css                      */import"./gameselect-9d669fe9.js";import{r as V,g as b,h as C}from"./queries.graphql.d-5a708c92.js";import{g}from"./windowLocation-8fc17d29.js";import"./dropDownMenu-e31617c8.js";class J{container;title;constructor(a,e){this.container=m(a),this.title=e,this.render(),this.setupShareButton()}render(){const a=`
        ...
        `;this.container.append(e)}}class j{container;bannerImage;tournamentDescription;conditionsOfConduct;widgets;constructor(a,e,s,n,i){this.container=m(a),this.bannerImage=e,this.tournamentDescription=s,this.conditionsOfConduct=n,this.widgets=i,this.render()}renderWidgets(){return this.widgets.map(a=>`
        ...
        `;this.container.append(e)}}const U="/assets/main-games-992f867d.png";class G{container;games;constructor(a,e){this.container=m(a),this.games=e,this.render(),this.initializeSwiper()}renderGames(){return this.games.map(a=>`
...
</div>`)}}class M{participants;container;constructor(a,e){this.container=document.getElementById(a),this.participants=e,this.render()}render(){this.container.innerHTML="";const a=document.createElement("div");a.className="tournament-page__participants",this.participants.forEach(e=>{const s=document.createElement("div");s.className="tournament-page-participants__item";const n=document.createElement("div");n.className="tournament-page-participants__item-number";const i=document.createElement("div");i.className="tournament-page-participants__item-avatar";const r=document.createElement("img");r.src=e.avatarUrl,r.alt=e.name,i.appendChild(r);const c=document.createElement("div");c.className="tournament-page-participants__item-name",c.textContent=e.name;const d=document.createElement("div");d.className="tournament-page-participants__item-rank",d.textContent=e.rank.toString(),s.append(n,i,c,d),a.appendChild(s)}),this.container.append(a)}}class N{container;constructor(a){this.container=m(a),this.render()}render(){this.container.append(`<div class="tournament-page__games">
